            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline">
                        ...
                        <a href="dokumen.php" class="btn btn-danger">Reset</a>
                    </form>
                    <br>
                    ...
                    <div align="right">
                        <ul class="pagination">
                            ...
                            ?>
                                ...
                                if ($kolomCari == "" && $kolomKataKunci == "") {
                                ?>
                                    <li><a href="dokumen.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
                                <?php
                                } else {
                                ?>
                                    <li><a href="dokumen.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $LinkPrev; ?>">Previous</a></li>
                            <?php
                                }
                            }
                            ?>
                            ...
                            for ($i = $startNumber; $i <= $endNumber; $i++) {
                                ...
                                if ($kolomCari == "" && $kolomKataKunci == "") {
                            ?>
                                    <li<?php echo $linkActive; ?>><a href="dokumen.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>

                                    <?php
                                } else {
                                    ?>
                                        <li<?php echo $linkActive; ?>><a href="dokumen.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php
                                }
                            }
                                    ?>
                                    ...
                                    ?>
                                        ...
                                        if ($kolomCari == "" && $kolomKataKunci == "") {
                                        ?>
                                            <li><a href="dokumen.php?page=<?php echo $linkNext; ?>">Next</a></li>
                                        <?php
                                        } else {
                                        ?>
                                            <li><a href="dokumen.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $linkNext; ?>">Next</a></li>
                                    <?php
                                        }
                                    }
                                    ?>
